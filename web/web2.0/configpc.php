...
<?
  $table="btc_pc_inventory";
  $empty=0;

  $fields = array(Name, OS, IPAddress, Login, Password, Connection, "Interface", "InterfaceIP", RemotePower, RPLogin, RPPassword);
  $req = array(Name, OS, IPAddress, Login, Password, Connection, "Interface", "InterfaceIP");
...
<html>
  <head>
    ...
    <title>Bivio Test Center - Config PC Device</title>
  </head>
  <body>
    <form method="post">
    <table border=0 cellpadding=0 cellspacing=0 valign=top align=center width=100%>
    <tr align=left><th><h2>Configure PC Device</h2></th></tr>
<?
    if ( $msg != "" ) {
...
?>
    ...
    <input type=hidden name="Class" value="pc">
...
?>
    ...
    <tr><th>
      ...
      <tr>
      <td width=50% align=center><input type="submit" value="Register PC" /></td>
