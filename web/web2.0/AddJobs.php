  ...
  if ( $_POST['RunTest'] == "Run" ) {
    ...
    if ( $_POST['-testbed'] != "Select" ) {
      ...
      foreach ($_POST as $key => $value) {
        ...
        // do not process the nccsinstall if zero
        if ($key == "-nccsinstall" && $value == "0") {
          continue;
        }
...
?>
  ...
  <td>
    <table id=border border=1 farem=box rules=all cellpadding=5 cellspacing=0 valign=top width=100%>
      ...
      <td valign=top>
      <table border=0 cellpadding=5 cellspacing=0 valign=top align=left width=100%>
        <tr><th align=left>Enter a NCCS Build

          <div class="tt"><a href="#"><image src=info.png align=absmiddle border=0>
            <div class="tooltip">Enter the NCCS build string. This is the compressed tar ball.<br>
              <br>Example : 5.0.7-1_NCCS-1.3.1-7.201010172002.tar.gz.
            </div></a>
          </div>

        </th></tr>
        <tr><td><input type=text name=-nccsbuild size=40 / ></td></tr>
      </table>
      </td>

      <td valign=top>
      <table border=0 cellpadding=5 cellspacing=0 valign=top align=left width=100%>
        <tr><th align=left>Enable NCCSinstall

          <div class="tt"><a href="#"><image src=info.png align=absmiddle border=0>
            <div class="tooltip">Select if you wish to install the NCCS build.<br>
              <br>This will install the build into the system first and then begin the tests.<br>
              <br>Default is : Disabled
            </div></a>
          </div>
        ...
        <tr><td><input type=radio name=-nccsinstall checked value=0 / >Disabled</td></tr>
        <tr><td><input type=radio name=-nccsinstall value=1 / >Enabled</td></tr>
      </table>
      </td>
